       ...
       <div className="flex justify-between items-center mb-4 pb-4 border-b">
         <div className="flex items-center gap-6">
             <div>
                ...
                <p className="text-xs text-gray-400 mt-1">Manage class and content</p>
             </div>
             ...
             <div className="flex bg-gray-100 p-1 rounded-xl">
                 <button 
                    ...
                    className={`px-4 py-2 rounded-lg font-bold transition-all ${activeTab === 'dashboard' ? 'bg-white shadow-sm text-blue-600' : 'text-gray-500 hover:text-gray-700'}`}
                 >
                    Dashboard
                 </button>
                 <button 
                    onClick={() => setActiveTab('builder')}
                    className={`px-4 py-2 rounded-lg font-bold transition-all ${activeTab === 'builder' ? 'bg-white shadow-sm text-blue-600' : 'text-gray-500 hover:text-gray-700'}`}
                 >
                    Lesson Builder
                 </button>
             </div>
